...
#include "../../src/userlib/qxtcheckcombobox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QxtCheckComboBox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 82, 12)
    ...
    "\0items\0setCheckedItems\0separator\0"
    "defaultText\0checkedItems"
};
...
void QxtCheckComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QxtCheckComboBox::*_t)(const QStringList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QxtCheckComboBox::checkedItemsChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QxtCheckComboBox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_QxtCheckComboBox.data,
      qt_meta_data_QxtCheckComboBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QxtCheckComboBox.stringdata))
