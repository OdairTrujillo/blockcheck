...
insert into tblQUOTATIONS (quot_date, quot_name, quot_address, city_id, quot_contact, quot_cel, quot_mail, quot_inspect_type, use_id, quot_voltage_level, quot_capacity, quot_phases, quot_project_area, quot_area_type, quot_network_type, quot_network_long, quot_boxes, quot_scope, thrd_id) 
	    values ('2012-05-15', 'Edificio las Camelias', 'Av 15, Transv 80', 1, 'Jacinto Tocaima', '3134324566', 'lilola@hotmail.com', 1, 1, 1, 150, 3, 2500, 1, 2, 450, 20, 'Acometida e instalaciones interiores', 1);
insert into tblQUOTATIONS (quot_date, quot_name, quot_address, city_id, quot_contact, quot_cel, quot_mail, quot_inspect_type, use_id, quot_voltage_level, quot_capacity, quot_phases, quot_project_area, quot_area_type, quot_network_type, quot_network_long, quot_boxes, quot_scope, thrd_id) 
	    values ('2012-05-20', 'Centro Comercial La Aurora', 'Cra 7ª Nº33-12', 1, 'Lazaro Buenavida', '5602345', 'truchocarucho@gmail.com', 1, 2, 1, 75, 3, 13500, 1, 1, 600, 35, 'Acometida aérea, subestación tipo poste y Tablero general', 2);
insert into tblQUOTATIONS (quot_date, quot_name, quot_address, city_id, quot_contact, quot_cel, quot_mail, quot_inspect_type, use_id, quot_voltage_level, quot_capacity, quot_phases, quot_project_area, quot_area_type, quot_network_type, quot_network_long, quot_boxes, quot_scope, thrd_id) 
	    values ('2012-06-21', 'Acerías Ternium', 'Kilómetro 15 autopista del café', 100, 'Rogelio Pataquiva', '3004256060', 'ingenieria@ternium.com', 1, 3, 2, 1500, 3, 6500, 3, 3, 350, 60, 'Caldera con Cogeneración', 3);
insert into tblQUOTATIONS (quot_date, quot_name, quot_address, city_id, quot_contact, quot_cel, quot_mail, quot_inspect_type, use_id, quot_voltage_level, quot_capacity, quot_phases, quot_project_area, quot_area_type, quot_network_type, quot_network_long, quot_boxes, quot_scope, thrd_id) 
	    values ('2012-06-22', 'Acerías Ternium', 'Kilómetro 15 autopista del café', 100, 'Hernando Martelo', '3204526987', 'proyectos@ternium.com', 1, 3, 2, 1000, 3, 250, 3, 2, 50, 10, 'Horno de arco eléctrico', 3);
...
insert into tblPROPOSALS (prop_date, prop_scope, prop_value, prop_iva, prop_viatical, prop_total_value, user_id, prop_user_perc, prop_payway, prop_approval, prop_observ, quot_id) 
	    values ('2012-05-16', 'Acometida e instalaciones interiores', 300000, 48000, 60000, 408000, 1, 0.15, '50% - 50%', 'Aprobada', 'Sin observaciones', 1);
insert into tblPROPOSALS (prop_date, prop_scope, prop_value, prop_iva, prop_viatical, prop_total_value, user_id, prop_user_perc, prop_payway, prop_approval, prop_observ, quot_id) 
	    values ('2012-05-21', 'Subestación tipo poste y Tablero general', 1200000, 192000, 50000, 1442000, 2, 0.2, '100%', 'Aprobada', 'Acordar estadía', 2);
insert into tblPROPOSALS (prop_date, prop_scope, prop_value, prop_iva, prop_viatical, prop_total_value, user_id, prop_user_perc, prop_payway, prop_approval, prop_observ, quot_id) 
	    values ('2012-05-23','Caldera con Cogeneración', 3000000, 480000, 600000, 4080000, 3, 0.25, 'A Convenir', 'Aprobada', 'Solicitar EPP adicionales', 3);
