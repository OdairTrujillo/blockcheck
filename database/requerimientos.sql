...
--
-- Name: seq_auditor_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_auditor_id', 3, true);


--
-- Name: seq_city_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_city_id', 1, false);


--
-- Name: seq_constructor_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_constructor_id', 3, true);


--
-- Name: seq_designer_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_designer_id', 4, true);


--
-- Name: seq_dictum_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_dictum_id', 1, false);


--
-- Name: seq_dictum_req_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_dictum_req_id', 1, false);


--
-- Name: seq_document_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_document_id', 36, true);


--
-- Name: seq_inspection_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_inspection_id', 1, false);


--
-- Name: seq_inspector_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_inspector_id', 28, true);


--
-- Name: seq_mov_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_mov_id', 3, true);


--
-- Name: seq_process_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_process_id', 9, true);


--
-- Name: seq_prop_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_prop_id', 3, true);


--
-- Name: seq_propdocument_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_propdocument_id', 20, true);


--
-- Name: seq_quot_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_quot_id', 4, true);


--
-- Name: seq_quotproc_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_quotproc_id', 6, true);


--
-- Name: seq_record_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_record_id', 4, true);


--
-- Name: seq_requirement_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_requirement_id', 1, false);


--
-- Name: seq_so_document_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_so_document_id', 18, true);


--
-- Name: seq_so_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_so_id', 3, true);


--
-- Name: seq_so_record_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_so_record_id', 6, true);


--
-- Name: seq_state_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_state_id', 1, false);


--
-- Name: seq_sub_dictum_req_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_sub_dictum_req_id', 1, false);


--
-- Name: seq_subdictum_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_subdictum_id', 1, false);


--
-- Name: seq_subproc_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_subproc_id', 5, true);


--
-- Name: seq_thrd_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_thrd_id', 3, true);


--
-- Name: seq_trck_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_trck_id', 1, true);


--
-- Name: seq_use_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_use_id', 3, true);


--
-- Name: seq_user_id; Type: SEQUENCE SET; Schema: public; Owner: riguser
--

SELECT pg_catalog.setval('seq_user_id', 7, true);


--
-- Data for Name: tblauditors; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblauditors VALUES (1, 'No Asignado', '', '', '');
INSERT INTO tblauditors VALUES (2, 'Ricardo Ordui', 'CU-202529', 'rigualisto@unal.edu.co', '3005938675');
INSERT INTO tblauditors VALUES (3, 'Mariana Solano', 'CL-308765', 'marianilla@hotmail.com', '3117938478');


--
-- Data for Name: tblstates; Type: TABLE DATA; Schema: public; Owner: riguser
--
...
--
-- Data for Name: tblcities; Type: TABLE DATA; Schema: public; Owner: riguser
--
...
--
-- Data for Name: tblconstructors; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblconstructors VALUES (1, 'No Asignado', '', '', '');
INSERT INTO tblconstructors VALUES (2, 'José Joseles', 'CL-002523', 'suabelito@yahoo.com', '3312938476');
INSERT INTO tblconstructors VALUES (3, 'Fulgencio Suicida', 'AN-502520', 'lalolambda@hotmail.com', '3012978679');


--
-- Data for Name: tbldesigners; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tbldesigners VALUES (1, 'No Asignado', '', '', '');
INSERT INTO tbldesigners VALUES (2, 'Carlos carriazo', 'CU-802525', 'cariarriozo@hotmail.com', '3012938475');
INSERT INTO tbldesigners VALUES (3, 'Ermelindo buenavida', 'CL-802530', 'emispis@hotmail.com', '3212938678');
INSERT INTO tbldesigners VALUES (4, 'Fulgencio Batista', 'AN-306530', 'fulgis@hotmail.com', '3003938970');


--
-- Data for Name: tblinspectors; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblinspectors VALUES (1, 'none', 'none', 'none', 'none', 'none', 'none', 0, '0');
INSERT INTO tblinspectors VALUES (2, 'Alex Dario Lasso Hidalgo', 'Nariño', 'none', 'none', 'none', 'none', 0.25, '91815338');
INSERT INTO tblinspectors VALUES (3, 'Alfonso Ramirez Gonzalez', 'Santander', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (4, 'Carlos Mauricio Salgado', 'Caldas', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (5, 'Diego Ceron', 'Cauca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (6, 'Fernando sanchez', 'Tolima', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (7, 'Fernando cardona', 'Bogotá', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (8, 'Ingrid Ospina', 'Bogotá', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (9, 'Jaime lopez quintero', 'Bogotá', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (10, 'Javier Augusto Osorio Cristancho', 'Boyacá', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (11, 'John Alexander silvara', 'Amazonas', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (12, 'Juan carlos noreña', 'Antioquia', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (13, 'Lenny Rojas', 'Cajamarca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (14, 'Leonel Orrego', 'Santander', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (15, 'Marina Belen Mora Nuñes ', 'Cajamarca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (16, 'Miller hernan orozco', 'Cauca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (17, 'Olando Arias wilches', 'Barranquilla', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (18, 'Pedro José Burgos', 'Cordoba', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (19, 'Pedro Nel Goméz Peñaloza', 'Arauca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (20, 'Pedro pablo barbosa', 'Bogotá', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (21, 'Rafael Arismendi', 'Santander', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (22, 'Salomon Fabian Rincon', 'Cajamarca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (23, 'Willian Lisandro Montoya', 'Cajamarca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (24, 'Wilson Beltran Ramos', 'Cajamarca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (25, 'Cayetano Rugeles Mantilla', 'Nacional', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (26, 'Jesus Octaviani Hernandez', 'Nacional', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (27, 'David Moncayo Gonzalez', 'Cundinamarca', 'none', 'none', 'none', 'none', 0.25, '0');
INSERT INTO tblinspectors VALUES (28, 'Simon Peña Mendoza', 'Cordoba', 'none', 'none', 'none', 'none', 0.25, '0');


--
-- Data for Name: tblthirdparties; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblthirdparties VALUES (1, '111111', 'Constructora Mejía S.A', 'Aurelio Cheverony', '1234578', 'Cra 7ª Nº 3-21', 'aurelito@gmail.com', '3209874532', '8765432', 1);
INSERT INTO tblthirdparties VALUES (2, '222222', 'Ingelectricos del Norte', 'Marino Gomez', '9123448', 'Av 34 Cll 24', 'marinillo@gmail.com', '3087654234', '2578987', 2);
INSERT INTO tblthirdparties VALUES (3, '333333', 'Ingeniería Robitech', 'Alfonso Medina', '12345678', 'Transv 80 Cra 25', 'gerencia@ingrobitech.com', '3004569887', '4563421', 3);


--
-- Data for Name: tbluses; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tbluses VALUES (1, 'Residencial');
INSERT INTO tbluses VALUES (2, 'Comercial');
INSERT INTO tbluses VALUES (3, 'Industrial');


--
-- Data for Name: tblquotations; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblquotations VALUES (1, '2012-05-15', 'Edificio las Camelias', 'Acometida e instalaciones interiores', 'Jacinto Tocaima', 'Av 15, Transv 80', 'lilola@hotmail.com', '3134324566', '8632345', 'RETIE', 1, 1, 1);
INSERT INTO tblquotations VALUES (2, '2012-05-20', 'Centro Comercial La Aurora', 'Subestación tipo poste y Tablero general', 'Lazaro Buenavida', 'Cra 7ª Nº33-12', 'truchocarucho@gmail.com', '', '5602345', 'RETIE', 2, 50, 2);
INSERT INTO tblquotations VALUES (3, '2012-05-21', 'Acerías Ternium', 'Caldera con Cogeneración', 'Rogelio Pataquiva', 'Kilómetro 15 autopista del café', 'ingenieria@ternium.com', '3004256060', '2603456', 'RETIE', 3, 100, 3);
INSERT INTO tblquotations VALUES (4, '2012-08-22', 'Cicolsa', 'Transformador de Potencia', 'Rodrigo Lara Bonilla', 'Kilómetro 1 vía bogotá', 'comercial@cicolsa.com', '3104256060', '8743456', 'RETIE', 3, 2, 2);


--
-- Data for Name: tblusers; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblusers VALUES (1, 'none', 'none', 'none', 'none', 0, 'none', 'none', 'none', 'none', 'none', 0, '0');
INSERT INTO tblusers VALUES (2, 'leonardo', '123', 'Leonardo Moreno', 'Comercial', 2, 'none', 'none', 'none', 'none', 'none', 0.200000000000000011, '21815238');
INSERT INTO tblusers VALUES (3, 'angelica', '123', 'Angelica Cristina Sierra', 'Documentos', 2, 'none', 'none', 'none', 'none', 'none', 0.200000000000000011, '0');
INSERT INTO tblusers VALUES (4, 'andres', '123', 'Andres Bazurto', 'Comercial', 2, 'none', 'none', 'none', 'none', 'none', 0.200000000000000011, '0');
INSERT INTO tblusers VALUES (5, 'luza', '123', 'Luz Angela Barrera', 'Comercial', 2, 'none', 'none', 'none', 'none', 'none', 0.200000000000000011, '0');
INSERT INTO tblusers VALUES (6, 'sandra', '123', 'Sandra Milena Hernandez', 'Contabilidad', 2, 'none', 'none', 'none', 'none', 'none', 0.200000000000000011, '0');
INSERT INTO tblusers VALUES (7, 'edwin', '123', 'Edwin José Trujillo', 'Ingenieria', 2, 'none', 'none', 'none', 'none', 'none', 0.200000000000000011, '0');


--
-- Data for Name: tblproposals; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblproposals VALUES (1, '2012-05-16', 'Acometida e instalaciones interiores', 300000, 48000, 60000, 408000, '50% - 50%', 'Aprobada', 0.149999999999999994, 0.25, 'Sin observaciones', 1, 2, 2);
INSERT INTO tblproposals VALUES (2, '2012-05-21', 'Subestación tipo poste y Tablero general', 1200000, 192000, 50000, 1442000, '100%', 'Aprobada', 0.200000000000000011, 0.23000000000000001, 'Sin observaciones', 2, 3, 3);
INSERT INTO tblproposals VALUES (3, '2012-05-23', 'Caldera con Cogeneración', 3000000, 480000, 600000, 4080000, 'A Convenir', 'Aprobada', 0.25, 0.149999999999999994, 'Sin observaciones', 3, 3, 2);


--
-- Data for Name: tblserviceorders; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblserviceorders VALUES (1, '2012-05-18', 'Acometida e instalaciones interiores', 'No se observan anomalías', 'Sin Procesar', 'Sin Procesar', 'Sin Procesar', 1);
INSERT INTO tblserviceorders VALUES (2, '2012-06-22', 'Subestación tipo poste y Tablero general', 'No se observan anomalías', 'Sin Procesar', 'Sin Procesar', 'Sin Procesar', 2);
INSERT INTO tblserviceorders VALUES (3, '2012-07-26', 'Caldera con Cogeneración', 'No se observan anomalías', 'Sin Procesar', 'Sin Procesar', 'Sin Procesar', 3);


--
-- Data for Name: tblinspections; Type: TABLE DATA; Schema: public; Owner: riguser
--



--
-- Data for Name: tbldictums; Type: TABLE DATA; Schema: public; Owner: riguser
--



--
-- Data for Name: tbldictumreqs; Type: TABLE DATA; Schema: public; Owner: riguser
--



--
-- Data for Name: tbldocuments; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tbldocuments VALUES (1, 'a - Análisis de carga', 'RETIE');
INSERT INTO tbldocuments VALUES (2, 'b - Cálculo de transformadores', 'RETIE');
INSERT INTO tbldocuments VALUES (3, 'c - Análisis de nivel de tensión requerido', 'RETIE');
INSERT INTO tbldocuments VALUES (4, 'd - Distancias de seguridad', 'RETIE');
INSERT INTO tbldocuments VALUES (5, 'e - Cálculos de regulación', 'RETIE');
INSERT INTO tbldocuments VALUES (6, 'f - Cálculos de pérdidas de energía', 'RETIE');
INSERT INTO tbldocuments VALUES (7, 'g - Análisis de cortocircuito y falla a tierra', 'RETIE');
INSERT INTO tbldocuments VALUES (8, 'h - Cálculo de coordinación de protecciones', 'RETIE');
INSERT INTO tbldocuments VALUES (9, 'i - Cálculo económico de conductores', 'RETIE');
INSERT INTO tbldocuments VALUES (10, 'j - Cálculo de ductos , (tuberías, canalizaciones, canaletas, blindobarras)', 'RETIE');
INSERT INTO tbldocuments VALUES (11, 'k - Cálculo del sistema de puestas a tierra', 'RETIE');
INSERT INTO tbldocuments VALUES (12, 'l - Análisis de protección contra rayos', 'RETIE');
INSERT INTO tbldocuments VALUES (13, 'm - Cálculo mecánico de estructuras', 'RETIE');
INSERT INTO tbldocuments VALUES (14, 'n - Análisis de coordinación de aislamiento', 'RETIE');
INSERT INTO tbldocuments VALUES (15, 'o - Análisis de riesgos eléctricos y medidas para mitigarlos', 'RETIE');
INSERT INTO tbldocuments VALUES (16, 'p - Cálculo de campos electromagnéticos en áreas o espacios cercanos a elementos con altas
tensiones o altas corrientes donde desarrollen actividades rutinarias las personas', 'RETIE');
INSERT INTO tbldocuments VALUES (17, 'q - Cálculo de iluminación', 'RETIE');
INSERT INTO tbldocuments VALUES (18, 'r - Especificaciones de construcción complementarias a los planos incluyendo las de tipo técnico de
equipos y materiales', 'RETIE');
INSERT INTO tbldocuments VALUES (19, 's - Justificación técnica de desviación de la NTC 2050 cuando sea permitido, siempre y cuando no
comprometa la seguridad de las personas o de la instalación', 'RETIE');
INSERT INTO tbldocuments VALUES (20, 't - Diagramas unifilares', 'RETIE');
INSERT INTO tbldocuments VALUES (21, 'u - Planos eléctricos de construcción', 'RETIE');
INSERT INTO tbldocuments VALUES (22, 'v - Los demás estudios que el tipo de instalación requiera para su correcta y segura operación', 'RETIE');
INSERT INTO tbldocuments VALUES (23, 'Archivo Fotográfico', 'RIG');
INSERT INTO tbldocuments VALUES (24, 'Orden de Servicio', 'RIG');
INSERT INTO tbldocuments VALUES (25, 'Declaración de independencia, Imparcialidad y Confidencialidad', 'RIG');
INSERT INTO tbldocuments VALUES (26, 'Matriz de Selección', 'RIG');
INSERT INTO tbldocuments VALUES (27, 'Acta de inspección', 'RIG');
INSERT INTO tbldocuments VALUES (28, 'Declaración de cumplimento del reglamento técnico de instalaciones eléctricas', 'RIG');
INSERT INTO tbldocuments VALUES (29, 'Fotocopia de la matricula profesional del constructor, diseñador e Interventor', 'RIG');
INSERT INTO tbldocuments VALUES (30, 'Listado de Productos con certificado Retie', 'RIG');
INSERT INTO tbldocuments VALUES (31, 'Certificados de Productos o constancia de la verificación – Retie', 'RIG');
INSERT INTO tbldocuments VALUES (32, 'Listas de Verificación', 'RIG');
INSERT INTO tbldocuments VALUES (33, 'Predictamen de Instalaciones eléctricas', 'RIG');
INSERT INTO tbldocuments VALUES (34, 'Diagrama unifilar', 'RIG');
INSERT INTO tbldocuments VALUES (35, 'Planos y/o esquemas eléctricos', 'RIG');
INSERT INTO tbldocuments VALUES (36, 'Análisis y memorias de calculo', 'RIG');


--
-- Data for Name: tblmovements; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblmovements VALUES (1, 'FACTURA', '2012-07-26', 1, 'FC0000001', 'Constructora Mejía S.A', '111111', 50000, 'Pago de factura');
INSERT INTO tblmovements VALUES (2, 'PAGO INSPECTOR', '2012-07-26', 1, 'RC0000001', 'Alex Dario Lasso Hidalgo', '91815338', 20000, 'Pago de inspector');
INSERT INTO tblmovements VALUES (3, 'PAGO COMERCIAL', '2012-07-26', 1, 'RC0000001', 'Leonardo Moreno', '21815238', 30000, 'Pago de comercial');


--
-- Data for Name: tblprocesses; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblprocesses VALUES (1, 'Generación');
INSERT INTO tblprocesses VALUES (2, 'Transmisión');
INSERT INTO tblprocesses VALUES (3, 'Transformación');
INSERT INTO tblprocesses VALUES (4, 'Distribución');
INSERT INTO tblprocesses VALUES (5, 'Uso Final');
INSERT INTO tblprocesses VALUES (6, 'Alumbrado Exterior');
INSERT INTO tblprocesses VALUES (7, 'Alumbrado Interior');
INSERT INTO tblprocesses VALUES (8, 'Especiales');
INSERT INTO tblprocesses VALUES (9, 'Normas Voluntarias');


--
-- Data for Name: tblpropdocuments; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblpropdocuments VALUES (1, 1, 1);
INSERT INTO tblpropdocuments VALUES (2, 1, 2);
INSERT INTO tblpropdocuments VALUES (3, 1, 3);
INSERT INTO tblpropdocuments VALUES (4, 1, 4);
INSERT INTO tblpropdocuments VALUES (5, 1, 16);
INSERT INTO tblpropdocuments VALUES (6, 2, 5);
INSERT INTO tblpropdocuments VALUES (7, 2, 7);
INSERT INTO tblpropdocuments VALUES (8, 2, 8);
INSERT INTO tblpropdocuments VALUES (9, 2, 9);
INSERT INTO tblpropdocuments VALUES (10, 2, 10);
INSERT INTO tblpropdocuments VALUES (11, 2, 11);
INSERT INTO tblpropdocuments VALUES (12, 2, 12);
INSERT INTO tblpropdocuments VALUES (13, 3, 1);
INSERT INTO tblpropdocuments VALUES (14, 3, 2);
INSERT INTO tblpropdocuments VALUES (15, 3, 5);
INSERT INTO tblpropdocuments VALUES (16, 3, 8);
INSERT INTO tblpropdocuments VALUES (17, 3, 10);
INSERT INTO tblpropdocuments VALUES (18, 3, 12);
INSERT INTO tblpropdocuments VALUES (19, 3, 14);
INSERT INTO tblpropdocuments VALUES (20, 3, 15);


--
-- Data for Name: tblquotprocesses; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblquotprocesses VALUES (1, 1, 4);
INSERT INTO tblquotprocesses VALUES (2, 2, 2);
INSERT INTO tblquotprocesses VALUES (3, 2, 3);
INSERT INTO tblquotprocesses VALUES (4, 2, 4);
INSERT INTO tblquotprocesses VALUES (5, 3, 1);
INSERT INTO tblquotprocesses VALUES (6, 4, 3);


--
-- Data for Name: tblrecords; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblrecords VALUES (1, 'Sin Archivar');
INSERT INTO tblrecords VALUES (2, 'AZ100');
INSERT INTO tblrecords VALUES (3, 'AZ101');
INSERT INTO tblrecords VALUES (4, 'AZ202');


--
-- Data for Name: tblrequirements; Type: TABLE DATA; Schema: public; Owner: riguser
--
...
INSERT INTO tblrequirements VALUES (26, 'Resistencia de puesta a tierra', 1);
...
INSERT INTO tblrequirements VALUES (51, 'Resistencia de puesta a tierra', 2);
...
INSERT INTO tblrequirements VALUES (84, 'Resistencia de puesta a tierra. ', 3);
...
INSERT INTO tblrequirements VALUES (111, 'Resistencia de puesta a tierra. ', 4);
...
INSERT INTO tblrequirements VALUES (138, 'Resistencia de puesta a tierra (4,8 ?)           ', 5);
...
--
-- Data for Name: tblsodocuments; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblsodocuments VALUES (1, 1, 23);
INSERT INTO tblsodocuments VALUES (2, 1, 24);
INSERT INTO tblsodocuments VALUES (3, 1, 25);
INSERT INTO tblsodocuments VALUES (4, 1, 27);
INSERT INTO tblsodocuments VALUES (5, 1, 29);
INSERT INTO tblsodocuments VALUES (6, 1, 30);
INSERT INTO tblsodocuments VALUES (7, 2, 23);
INSERT INTO tblsodocuments VALUES (8, 2, 24);
INSERT INTO tblsodocuments VALUES (9, 2, 25);
INSERT INTO tblsodocuments VALUES (10, 2, 28);
INSERT INTO tblsodocuments VALUES (11, 2, 30);
INSERT INTO tblsodocuments VALUES (12, 2, 31);
INSERT INTO tblsodocuments VALUES (13, 3, 23);
INSERT INTO tblsodocuments VALUES (14, 3, 24);
INSERT INTO tblsodocuments VALUES (15, 3, 26);
INSERT INTO tblsodocuments VALUES (16, 3, 29);
INSERT INTO tblsodocuments VALUES (17, 3, 30);
INSERT INTO tblsodocuments VALUES (18, 3, 32);


--
-- Data for Name: tblsorecords; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblsorecords VALUES (1, 1, 2);
INSERT INTO tblsorecords VALUES (2, 1, 3);
INSERT INTO tblsorecords VALUES (3, 2, 2);
INSERT INTO tblsorecords VALUES (4, 3, 2);
INSERT INTO tblsorecords VALUES (5, 3, 3);
INSERT INTO tblsorecords VALUES (6, 3, 4);


--
-- Data for Name: tblsotracking; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblsotracking VALUES (1, 1, '2012-07-26', 'Angelica Cristina Sierra', '2012-08-21', 'Leonardo Moreno', 'Envío Nacional', 'Envía', '111522525-3', 'Se envía Factura', 80);


--
-- Data for Name: tblsubdictums; Type: TABLE DATA; Schema: public; Owner: riguser
--



--
-- Data for Name: tblsubdictumreqs; Type: TABLE DATA; Schema: public; Owner: riguser
--



--
-- Data for Name: tblsubprocesses; Type: TABLE DATA; Schema: public; Owner: riguser
--

INSERT INTO tblsubprocesses VALUES (1, 'Subestación tipo poste', 'chelists/RIG-FO-001.html', 2);
INSERT INTO tblsubprocesses VALUES (2, 'Redes Aéreas', 'chelists/RIG-FO-002.html', 3);
INSERT INTO tblsubprocesses VALUES (3, 'Vivienda unifamiliar', 'chelists/RIG-FO-002.html', 4);
INSERT INTO tblsubprocesses VALUES (4, 'Subestación encapsulada', 'chelists/RIG-FO-005.html', 2);
INSERT INTO tblsubprocesses VALUES (5, 'Vivienda movil', 'chelists/RIG-FO-010.html', 4);
